...
ActiveRecord::Schema.define(version: 2018_08_14_222007) do
  ...
  create_table "followings", force: :cascade do |t|
    ...
    t.index ["influencer_id"], name: "index_followings_on_influencer_id"
  ...
  add_foreign_key "followings", "influencers"
